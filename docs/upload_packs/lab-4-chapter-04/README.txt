LABORATORY 4 - UPLOAD PACK
Chapter 4: probability
================================================================

WHAT THIS FOLDER IS

Everything Laboratory 4 needs, in one place. Use this when Claude cannot
...
1. Download all 6 files listed below.

2. Open a NEW conversation at claude.ai.

3. Drag all 6 files into the message box at once. Wait until each
...
SCRIPTS YOU CAN RUN FROM THIS PACK
    ...
    04_probability.py
        classical and empirical probability, conditional probability, independence, Bayes' Theorem, counting
